...
export default function Home() {
    return (
      ...
      <div className="objective"> 
        ...
        and functinal web experinces thriugh code, design and innovation.

        building modern, efficient and user foucesed web application using 
      ...
      <div className="Education">
        ...
        <p>Honour Bachelor of Technology- Software Development.</p>
